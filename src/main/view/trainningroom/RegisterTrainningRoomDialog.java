...
public class RegisterTrainningRoomDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public RegisterTrainningRoomDialog() {
		setTitle("Insert Trainning Room Details");
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(arg0 -> {
					try {
						...
						trainningRoom.setId(Integer.parseInt(txtId.getText()));
						trainningRoom.setName(txtName.getText());
						trainningRoom.setCapacity(Integer.parseInt(txtRoomCapacity.getText()));
						int result = service.save(trainningRoom);
						if (result > 0) {
